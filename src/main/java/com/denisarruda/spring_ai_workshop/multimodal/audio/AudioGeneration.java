package com.denisarruda.spring_ai_workshop.multimodal.audio;
...
public class AudioGeneration {
    ...
    @GetMapping("/speak")
    public ResponseEntity<byte[]> generateSpeech(@RequestParam(defaultValue = "It's a great time to be a Java & Spring Developer") String text) {
