package com.denisarruda.spring_ai_workshop.byod;
...
public class ModelComparison {
    ...
    public String models() {
        return chatClient.prompt()
                .user("Can you give me a up to date list popular large language models and their context windows?")
                .call()
                .content();
    }
    ...
    public String modelsStuffThePrompt() {
        ...
        return chatClient.prompt()
                .user(stuff + " Can you give me a up to date list popular large language models and their context windows?")
                .call()
                .content();
    }
}
